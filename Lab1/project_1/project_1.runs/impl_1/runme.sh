...
HD_PWD='D:/FPGA/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VOLK.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VOLK.tcl -notrace
